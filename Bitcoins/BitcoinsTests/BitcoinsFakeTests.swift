...
final class BitcoinsFakeTests: XCTestCase {
    ...
    func testDataFromApiRequest() throws {
        ...
        sut.request {_ in 
            XCTAssertEqual(self.sut.updatedRate?.gbp?.rate_float, 16029.5131)
            promise.fulfill()
        }
