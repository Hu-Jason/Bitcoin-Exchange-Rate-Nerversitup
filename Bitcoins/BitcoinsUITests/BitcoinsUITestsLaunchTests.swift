...
import XCTest
//MARK: I tried to writing UI test, but everytime I click the red Record button at the bottom of the editor window to records my interactions as test commands, the test crashes. Xcode reports an error infomation as bellow:
